      ...
      <section className="flex flex-col gap-7 items-center justify-around md:w-[70vw] w-full py-16 px-6 md:py-24 mx-auto flex-1 md:flex-row">
        ...
        <div className="flex flex-col items-start gap-5 md:w-[30vw]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-(--text-secondary) md:text-(--text-muted) md:text-3xl">
          ...
          <div className="hidden md:flex flex-row gap-4 justify-between w-auto">
            <button className="w-[10vw] border border-(--accent) rounded-xl min-h-auto p-3 bg-(--accent)">
              Zapisz sie online
            </button>
            <button className="w-[10vw] border border-(--border) rounded-xl min-h-auto p-3 bg-(--bg-secondary)">
              Sprawdz cennik
            </button>
          </div>
          <div className="flex flex-row bg-(--bg-secondary) justify-around border border-(--border) rounded-2xl w-full ">
            <section className="flex flex-col items-center justify-center gap-1 p-2 w-1/3">
              ...
              <p className="text-xs text-(--text-secondary)">zdawalność</p>
            </section>
            <section className="flex flex-col items-center justify-center gap-1 p-2 w-1/3 border-r border-l border-(--border)">
              ...
              <p className="text-xs text-(--text-secondary)">lat na rynku</p>
            </section>
            <section className="flex flex-col items-center justify-center gap-1 p-2 w-1/3">
              <p className="text-(--accent) font-bold text-2xl">1200+</p>
              <p className="text-xs text-(--text-secondary)">absolwentów</p>
            </section>
          </div>
        </div>

        {/* Правая колонка */}
        <section className="flex flex-col w-full gap-9 md:w-[20vw]">
          <div className="p-4 flex flex-col justify-around gap-2 md:gap-7 bg-(--bg-secondary) w-full rounded-xl border border-(--border)">
            ...
            <button className="w-full border border-(--border) rounded-xl min-h-auto p-2 bg-(--accent)">
              Zarezerwuj miejsce
            </button>
            <span className="text-(--text-muted) hidden flex-row justify-center md:flex">lub zadzwoń: +48 61 xxx xxxx</span>
          </div>
          <button className="block text-xl min-h-auto p-1.5 w-full border border-(--border) rounded-xl md:hidden">
