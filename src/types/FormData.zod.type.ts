...
export const schema = z.object({
  ...
  pesel: z.number({ message: "Pesel musi mieć 11 znaków" }).min(11, { message: "Pesel musi mieć 11 znaków" }).max(11, { message: "Pesel musi mieć 11 znaków" }),
  kurs: z.string().min(1, {message: 'Proszę wybrać kurs'}),
  telefon: z.number({ message: "Pesel musi mieć 11 znaków" }).min(9, { message: "Numer musi mieć 9 znaków" }).max(9, { message: "Numer musi mieć 9 znaków" }),
